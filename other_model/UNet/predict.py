...
def predict_img(net,device):
    ...
    for i_batch, sampled_batch in tqdm(enumerate(testloader)):
        ...
        _recall, _specificity, _precision, _F1, _F2, \
            _ACC_overall,_IoU_poly, _mIoU, _Dice = evaluate(output, gt, 0.5)
        ...
        result.save("./result/ASU_MAyo/{}".format(name[0]))
...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='./vision/TrainDataset/2024-11-29-09_35/best_epoch.pth',   # EdoScenebest_epoch
                        metavar='FILE',
                        help="Specify the file in which the model is stored")
    
    parser.add_argument('--test_img', type=str,
                    default=r'data/TestDataset/CVC-300/images', help='root dir for test_image')  # data/kvasir/Test_Folder/images
    parser.add_argument('--test_gt', type=str,
                    default=r'data/TestDataset/CVC-300/masks', help='root dir for test_gt')  # data/kvasir/Test_Folder/masks
    ...
    parser.add_argument('--output', type=str,
                    default=r'result/CVC_300/', help='Filenames of ouput images') 
