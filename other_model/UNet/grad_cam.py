...
ckpt_path = './checkpoints/kvasir/best_epoch.pth'
...
def get_args():
    ...
    parser.add_argument('--image-path', type=str, default='./data/kvasir/Train_Folder/image/cju0qkwl35piu0993l0dewei2.png',
...
if __name__ == '__main__':
    ...
    grad_cam = GradCam(model=model, feature_module=model.outc, \
...
def get_args():
    ...
    parser.add_argument('--use-cuda', action='store_true', default=False,
                        help='Use NVIDIA GPU acceleration')
    parser.add_argument('--image-path', type=str, default='./data/EndoScene/Train/images/1.png',
                        help='Input image path')
    args = parser.parse_args()
    args.use_cuda = args.use_cuda and torch.cuda.is_available()
    if args.use_cuda:
...
if __name__ == '__main__':
    ...
    # feature method, and a classifier method,
    # as in the VGG models in torchvision.
    path="result/checkpoint/kvasir/best_epoch.pth"
    net = UNet(n_channels=3, n_classes=1)
    net.load_state_dict(torch.load(path))
    grad_cam,_ = GradCam(model = net, feature_module=net.up2,\
