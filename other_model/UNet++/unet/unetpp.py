...
#     def __init__(self, n_channelss, middle_channels, n_classess, act_func=nn.ReLU(inplace=True)):
#         super(VGGBlock, self).__init__()
#         self.act_func = act_func
#         self.conv1 = nn.Conv2d(n_channelss, middle_channels, 3, padding=1)
#         self.bn1 = nn.BatchNorm2d(middle_channels)
#         self.conv2 = nn.Conv2d(middle_channels, n_classess, 3, padding=1)
#         self.bn2 = nn.BatchNorm2d(n_classess)
#
#     def forward(self, x):
#         out = self.conv1(x)
#         out = self.bn1(out)
...
class NestedUNet(nn.Module):
    def __init__(self, n_channels=3,n_classes=1,deepsupervision=False):
        super().__init__()
